...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_VARIABLE_ARGS_RAW = 266,   // VARIABLE_ARGS_RAW
    TOK_VARIABLE_ARGS_POST = 267,  // VARIABLE_ARGS_POST
    TOK_VARIABLE_ARGS_POST_RAW = 268, // VARIABLE_ARGS_POST_RAW
    TOK_VARIABLE_ARGS_GET = 269,   // VARIABLE_ARGS_GET
    TOK_VARIABLE_ARGS_GET_RAW = 270, // VARIABLE_ARGS_GET_RAW
    TOK_VARIABLE_FILES_SIZES = 271, // VARIABLE_FILES_SIZES
    TOK_VARIABLE_FILES_NAMES = 272, // VARIABLE_FILES_NAMES
    TOK_VARIABLE_FILES_TMP_CONTENT = 273, // VARIABLE_FILES_TMP_CONTENT
    TOK_VARIABLE_MULTIPART_FILENAME = 274, // VARIABLE_MULTIPART_FILENAME
    TOK_VARIABLE_MULTIPART_NAME = 275, // VARIABLE_MULTIPART_NAME
    TOK_VARIABLE_MATCHED_VARS_NAMES = 276, // VARIABLE_MATCHED_VARS_NAMES
    TOK_VARIABLE_MATCHED_VARS = 277, // VARIABLE_MATCHED_VARS
    TOK_VARIABLE_FILES = 278,      // VARIABLE_FILES
    TOK_VARIABLE_REQUEST_COOKIES = 279, // VARIABLE_REQUEST_COOKIES
    TOK_VARIABLE_REQUEST_HEADERS = 280, // VARIABLE_REQUEST_HEADERS
    TOK_VARIABLE_RESPONSE_HEADERS = 281, // VARIABLE_RESPONSE_HEADERS
    TOK_VARIABLE_GEO = 282,        // VARIABLE_GEO
    TOK_VARIABLE_REQUEST_COOKIES_NAMES = 283, // VARIABLE_REQUEST_COOKIES_NAMES
    TOK_VARIABLE_MULTIPART_PART_HEADERS = 284, // VARIABLE_MULTIPART_PART_HEADERS
    TOK_VARIABLE_ARGS_COMBINED_SIZE = 285, // VARIABLE_ARGS_COMBINED_SIZE
    TOK_VARIABLE_ARGS_GET_NAMES = 286, // VARIABLE_ARGS_GET_NAMES
    TOK_VARIABLE_ARGS_GET_NAMES_RAW = 287, // VARIABLE_ARGS_GET_NAMES_RAW
    TOK_VARIABLE_RULE = 288,       // VARIABLE_RULE
    TOK_VARIABLE_ARGS_NAMES = 289, // "Variable ARGS_NAMES"
    TOK_VARIABLE_ARGS_NAMES_RAW = 290, // VARIABLE_ARGS_NAMES_RAW
    TOK_VARIABLE_ARGS_POST_NAMES = 291, // VARIABLE_ARGS_POST_NAMES
    TOK_VARIABLE_ARGS_POST_NAMES_RAW = 292, // VARIABLE_ARGS_POST_NAMES_RAW
    TOK_VARIABLE_AUTH_TYPE = 293,  // "AUTH_TYPE"
    TOK_VARIABLE_FILES_COMBINED_SIZE = 294, // "FILES_COMBINED_SIZE"
    TOK_VARIABLE_FILES_TMP_NAMES = 295, // "FILES_TMPNAMES"
    TOK_VARIABLE_FULL_REQUEST = 296, // "FULL_REQUEST"
    TOK_VARIABLE_FULL_REQUEST_LENGTH = 297, // "FULL_REQUEST_LENGTH"
    TOK_VARIABLE_INBOUND_DATA_ERROR = 298, // "INBOUND_DATA_ERROR"
    TOK_VARIABLE_MATCHED_VAR = 299, // "MATCHED_VAR"
    TOK_VARIABLE_MATCHED_VAR_NAME = 300, // "MATCHED_VAR_NAME"
    TOK_VARIABLE_MSC_PCRE_ERROR = 301, // "MSC_PCRE_ERROR"
    TOK_VARIABLE_MSC_PCRE_LIMITS_EXCEEDED = 302, // "MSC_PCRE_LIMITS_EXCEEDED"
    TOK_VARIABLE_MULTIPART_BOUNDARY_QUOTED = 303, // VARIABLE_MULTIPART_BOUNDARY_QUOTED
    TOK_VARIABLE_MULTIPART_BOUNDARY_WHITESPACE = 304, // VARIABLE_MULTIPART_BOUNDARY_WHITESPACE
    TOK_VARIABLE_MULTIPART_CRLF_LF_LINES = 305, // "MULTIPART_CRLF_LF_LINES"
    TOK_VARIABLE_MULTIPART_DATA_AFTER = 306, // "MULTIPART_DATA_AFTER"
    TOK_VARIABLE_MULTIPART_DATA_BEFORE = 307, // VARIABLE_MULTIPART_DATA_BEFORE
    TOK_VARIABLE_MULTIPART_FILE_LIMIT_EXCEEDED = 308, // "MULTIPART_FILE_LIMIT_EXCEEDED"
    TOK_VARIABLE_MULTIPART_HEADER_FOLDING = 309, // "MULTIPART_HEADER_FOLDING"
    TOK_VARIABLE_MULTIPART_INVALID_HEADER_FOLDING = 310, // "MULTIPART_INVALID_HEADER_FOLDING"
    TOK_VARIABLE_MULTIPART_INVALID_PART = 311, // VARIABLE_MULTIPART_INVALID_PART
    TOK_VARIABLE_MULTIPART_INVALID_QUOTING = 312, // "MULTIPART_INVALID_QUOTING"
    TOK_VARIABLE_MULTIPART_LF_LINE = 313, // VARIABLE_MULTIPART_LF_LINE
    TOK_VARIABLE_MULTIPART_MISSING_SEMICOLON = 314, // VARIABLE_MULTIPART_MISSING_SEMICOLON
    TOK_VARIABLE_MULTIPART_SEMICOLON_MISSING = 315, // VARIABLE_MULTIPART_SEMICOLON_MISSING
    TOK_VARIABLE_MULTIPART_STRICT_ERROR = 316, // "MULTIPART_STRICT_ERROR"
    TOK_VARIABLE_MULTIPART_UNMATCHED_BOUNDARY = 317, // "MULTIPART_UNMATCHED_BOUNDARY"
    TOK_VARIABLE_OUTBOUND_DATA_ERROR = 318, // "OUTBOUND_DATA_ERROR"
    TOK_VARIABLE_PATH_INFO = 319,  // "PATH_INFO"
    TOK_VARIABLE_QUERY_STRING = 320, // "QUERY_STRING"
    TOK_VARIABLE_REMOTE_ADDR = 321, // "REMOTE_ADDR"
    TOK_VARIABLE_REMOTE_HOST = 322, // "REMOTE_HOST"
    TOK_VARIABLE_REMOTE_PORT = 323, // "REMOTE_PORT"
    TOK_VARIABLE_REQBODY_ERROR_MSG = 324, // "REQBODY_ERROR_MSG"
    TOK_VARIABLE_REQBODY_ERROR = 325, // "REQBODY_ERROR"
    TOK_VARIABLE_REQBODY_PROCESSOR_ERROR_MSG = 326, // "REQBODY_PROCESSOR_ERROR_MSG"
    TOK_VARIABLE_REQBODY_PROCESSOR_ERROR = 327, // "REQBODY_PROCESSOR_ERROR"
    TOK_VARIABLE_REQBODY_PROCESSOR = 328, // "REQBODY_PROCESSOR"
    TOK_VARIABLE_REQUEST_BASENAME = 329, // "REQUEST_BASENAME"
    TOK_VARIABLE_REQUEST_BODY_LENGTH = 330, // "REQUEST_BODY_LENGTH"
    TOK_VARIABLE_REQUEST_BODY = 331, // "REQUEST_BODY"
    TOK_VARIABLE_REQUEST_FILE_NAME = 332, // "REQUEST_FILENAME"
    TOK_VARIABLE_REQUEST_HEADERS_NAMES = 333, // VARIABLE_REQUEST_HEADERS_NAMES
    TOK_VARIABLE_REQUEST_LINE = 334, // "REQUEST_LINE"
    TOK_VARIABLE_REQUEST_METHOD = 335, // "REQUEST_METHOD"
    TOK_VARIABLE_REQUEST_PROTOCOL = 336, // "REQUEST_PROTOCOL"
    TOK_VARIABLE_REQUEST_URI_RAW = 337, // "REQUEST_URI_RAW"
    TOK_VARIABLE_REQUEST_URI = 338, // "REQUEST_URI"
    TOK_VARIABLE_RESOURCE = 339,   // "RESOURCE"
    TOK_VARIABLE_RESPONSE_BODY = 340, // "RESPONSE_BODY"
    TOK_VARIABLE_RESPONSE_CONTENT_LENGTH = 341, // "RESPONSE_CONTENT_LENGTH"
    TOK_VARIABLE_RESPONSE_CONTENT_TYPE = 342, // VARIABLE_RESPONSE_CONTENT_TYPE
    TOK_VARIABLE_RESPONSE_HEADERS_NAMES = 343, // VARIABLE_RESPONSE_HEADERS_NAMES
    TOK_VARIABLE_RESPONSE_PROTOCOL = 344, // "RESPONSE_PROTOCOL"
    TOK_VARIABLE_RESPONSE_STATUS = 345, // "RESPONSE_STATUS"
    TOK_VARIABLE_SERVER_ADDR = 346, // "SERVER_ADDR"
    TOK_VARIABLE_SERVER_NAME = 347, // "SERVER_NAME"
    TOK_VARIABLE_SERVER_PORT = 348, // "SERVER_PORT"
    TOK_VARIABLE_SESSION_ID = 349, // "SESSIONID"
    TOK_VARIABLE_UNIQUE_ID = 350,  // "UNIQUE_ID"
    TOK_VARIABLE_URL_ENCODED_ERROR = 351, // "URLENCODED_ERROR"
    TOK_VARIABLE_USER_ID = 352,    // "USERID"
    TOK_VARIABLE_WEB_APP_ID = 353, // "WEBAPPID"
    TOK_VARIABLE_STATUS = 354,     // "VARIABLE_STATUS"
    TOK_VARIABLE_STATUS_LINE = 355, // "VARIABLE_STATUS_LINE"
    TOK_VARIABLE_IP = 356,         // "VARIABLE_IP"
    TOK_VARIABLE_GLOBAL = 357,     // "VARIABLE_GLOBAL"
    TOK_VARIABLE_TX = 358,         // "VARIABLE_TX"
    TOK_VARIABLE_SESSION = 359,    // "VARIABLE_SESSION"
    TOK_VARIABLE_USER = 360,       // "VARIABLE_USER"
    TOK_RUN_TIME_VAR_ENV = 361,    // "RUN_TIME_VAR_ENV"
    TOK_RUN_TIME_VAR_XML = 362,    // "RUN_TIME_VAR_XML"
    TOK_ACTION_SETVAR = 363,       // "SetVar"
    TOK_SETVAR_OPERATION_EQUALS = 364, // SETVAR_OPERATION_EQUALS
    TOK_SETVAR_OPERATION_EQUALS_PLUS = 365, // SETVAR_OPERATION_EQUALS_PLUS
    TOK_SETVAR_OPERATION_EQUALS_MINUS = 366, // SETVAR_OPERATION_EQUALS_MINUS
    TOK_NOT = 367,                 // "NOT"
    TOK_OPERATOR_BEGINS_WITH = 368, // "OPERATOR_BEGINS_WITH"
    TOK_OPERATOR_CONTAINS = 369,   // "OPERATOR_CONTAINS"
    TOK_OPERATOR_CONTAINS_WORD = 370, // "OPERATOR_CONTAINS_WORD"
    TOK_OPERATOR_DETECT_SQLI = 371, // "OPERATOR_DETECT_SQLI"
    TOK_OPERATOR_DETECT_XSS = 372, // "OPERATOR_DETECT_XSS"
    TOK_OPERATOR_ENDS_WITH = 373,  // "OPERATOR_ENDS_WITH"
    TOK_OPERATOR_EQ = 374,         // "OPERATOR_EQ"
    TOK_OPERATOR_FUZZY_HASH = 375, // "OPERATOR_FUZZY_HASH"
    TOK_OPERATOR_GEOLOOKUP = 376,  // "OPERATOR_GEOLOOKUP"
    TOK_OPERATOR_GE = 377,         // "OPERATOR_GE"
    TOK_OPERATOR_GSB_LOOKUP = 378, // "OPERATOR_GSB_LOOKUP"
    TOK_OPERATOR_GT = 379,         // "OPERATOR_GT"
    TOK_OPERATOR_INSPECT_FILE = 380, // "OPERATOR_INSPECT_FILE"
    TOK_OPERATOR_IP_MATCH_FROM_FILE = 381, // "OPERATOR_IP_MATCH_FROM_FILE"
    TOK_OPERATOR_IP_MATCH = 382,   // "OPERATOR_IP_MATCH"
    TOK_OPERATOR_LE = 383,         // "OPERATOR_LE"
    TOK_OPERATOR_LT = 384,         // "OPERATOR_LT"
    TOK_OPERATOR_PM_FROM_FILE = 385, // "OPERATOR_PM_FROM_FILE"
    TOK_OPERATOR_PM = 386,         // "OPERATOR_PM"
    TOK_OPERATOR_RBL = 387,        // "OPERATOR_RBL"
    TOK_OPERATOR_RSUB = 388,       // "OPERATOR_RSUB"
    TOK_OPERATOR_RX_CONTENT_ONLY = 389, // "Operator RX (content only)"
    TOK_OPERATOR_RX = 390,         // "OPERATOR_RX"
    TOK_OPERATOR_RX_GLOBAL = 391,  // "OPERATOR_RX_GLOBAL"
    TOK_OPERATOR_STR_EQ = 392,     // "OPERATOR_STR_EQ"
    TOK_OPERATOR_STR_MATCH = 393,  // "OPERATOR_STR_MATCH"
    TOK_OPERATOR_UNCONDITIONAL_MATCH = 394, // "OPERATOR_UNCONDITIONAL_MATCH"
    TOK_OPERATOR_VALIDATE_BYTE_RANGE = 395, // "OPERATOR_VALIDATE_BYTE_RANGE"
    TOK_OPERATOR_VALIDATE_DTD = 396, // "OPERATOR_VALIDATE_DTD"
    TOK_OPERATOR_VALIDATE_HASH = 397, // "OPERATOR_VALIDATE_HASH"
    TOK_OPERATOR_VALIDATE_SCHEMA = 398, // "OPERATOR_VALIDATE_SCHEMA"
    TOK_OPERATOR_VALIDATE_URL_ENCODING = 399, // "OPERATOR_VALIDATE_URL_ENCODING"
    TOK_OPERATOR_VALIDATE_UTF8_ENCODING = 400, // "OPERATOR_VALIDATE_UTF8_ENCODING"
    TOK_OPERATOR_VERIFY_CC = 401,  // "OPERATOR_VERIFY_CC"
    TOK_OPERATOR_VERIFY_CPF = 402, // "OPERATOR_VERIFY_CPF"
    TOK_OPERATOR_VERIFY_SSN = 403, // "OPERATOR_VERIFY_SSN"
    TOK_OPERATOR_VERIFY_SVNR = 404, // "OPERATOR_VERIFY_SVNR"
    TOK_OPERATOR_WITHIN = 405,     // "OPERATOR_WITHIN"
    TOK_CONFIG_DIR_AUDIT_LOG_FMT = 406, // CONFIG_DIR_AUDIT_LOG_FMT
    TOK_JSON = 407,                // JSON
    TOK_NATIVE = 408,              // NATIVE
    TOK_ACTION_CTL_RULE_ENGINE = 409, // "ACTION_CTL_RULE_ENGINE"
    TOK_ACTION_ACCURACY = 410,     // "Accuracy"
    TOK_ACTION_ALLOW = 411,        // "Allow"
    TOK_ACTION_APPEND = 412,       // "Append"
    TOK_ACTION_AUDIT_LOG = 413,    // "AuditLog"
    TOK_ACTION_BLOCK = 414,        // "Block"
    TOK_ACTION_CAPTURE = 415,      // "Capture"
    TOK_ACTION_CHAIN = 416,        // "Chain"
    TOK_ACTION_CTL_AUDIT_ENGINE = 417, // "ACTION_CTL_AUDIT_ENGINE"
    TOK_ACTION_CTL_AUDIT_LOG_PARTS = 418, // "ACTION_CTL_AUDIT_LOG_PARTS"
    TOK_ACTION_CTL_BDY_JSON = 419, // "ACTION_CTL_BDY_JSON"
    TOK_ACTION_CTL_BDY_XML = 420,  // "ACTION_CTL_BDY_XML"
    TOK_ACTION_CTL_BDY_URLENCODED = 421, // "ACTION_CTL_BDY_URLENCODED"
    TOK_ACTION_CTL_FORCE_REQ_BODY_VAR = 422, // "ACTION_CTL_FORCE_REQ_BODY_VAR"
    TOK_ACTION_CTL_PARSE_XML_INTO_ARGS = 423, // "ACTION_CTL_PARSE_XML_INTO_ARGS"
    TOK_ACTION_CTL_REQUEST_BODY_ACCESS = 424, // "ACTION_CTL_REQUEST_BODY_ACCESS"
    TOK_ACTION_CTL_RULE_REMOVE_BY_ID = 425, // "ACTION_CTL_RULE_REMOVE_BY_ID"
    TOK_ACTION_CTL_RULE_REMOVE_BY_TAG = 426, // "ACTION_CTL_RULE_REMOVE_BY_TAG"
    TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 427, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_ID"
    TOK_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 428, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG"
    TOK_ACTION_DENY = 429,         // "Deny"
    TOK_ACTION_DEPRECATE_VAR = 430, // "DeprecateVar"
    TOK_ACTION_DROP = 431,         // "Drop"
    TOK_ACTION_EXEC = 432,         // "Exec"
    TOK_ACTION_EXPIRE_VAR = 433,   // "ExpireVar"
    TOK_ACTION_ID = 434,           // "Id"
    TOK_ACTION_INITCOL = 435,      // "InitCol"
    TOK_ACTION_LOG = 436,          // "Log"
    TOK_ACTION_LOG_DATA = 437,     // "LogData"
    TOK_ACTION_MATURITY = 438,     // "Maturity"
    TOK_ACTION_MSG = 439,          // "Msg"
    TOK_ACTION_MULTI_MATCH = 440,  // "MultiMatch"
    TOK_ACTION_NO_AUDIT_LOG = 441, // "NoAuditLog"
    TOK_ACTION_NO_LOG = 442,       // "NoLog"
    TOK_ACTION_PASS = 443,         // "Pass"
    TOK_ACTION_PAUSE = 444,        // "Pause"
    TOK_ACTION_PHASE = 445,        // "Phase"
    TOK_ACTION_PREPEND = 446,      // "Prepend"
    TOK_ACTION_PROXY = 447,        // "Proxy"
    TOK_ACTION_REDIRECT = 448,     // "Redirect"
    TOK_ACTION_REV = 449,          // "Rev"
    TOK_ACTION_SANITISE_ARG = 450, // "SanitiseArg"
    TOK_ACTION_SANITISE_MATCHED = 451, // "SanitiseMatched"
    TOK_ACTION_SANITISE_MATCHED_BYTES = 452, // "SanitiseMatchedBytes"
    TOK_ACTION_SANITISE_REQUEST_HEADER = 453, // "SanitiseRequestHeader"
    TOK_ACTION_SANITISE_RESPONSE_HEADER = 454, // "SanitiseResponseHeader"
    TOK_ACTION_SETENV = 455,       // "SetEnv"
    TOK_ACTION_SETRSC = 456,       // "SetRsc"
    TOK_ACTION_SETSID = 457,       // "SetSid"
    TOK_ACTION_SETUID = 458,       // "SetUID"
    TOK_ACTION_SEVERITY = 459,     // "Severity"
    TOK_ACTION_SKIP = 460,         // "Skip"
    TOK_ACTION_SKIP_AFTER = 461,   // "SkipAfter"
    TOK_ACTION_STATUS = 462,       // "Status"
    TOK_ACTION_TAG = 463,          // "Tag"
    TOK_ACTION_TRANSFORMATION_BASE_64_ENCODE = 464, // "ACTION_TRANSFORMATION_BASE_64_ENCODE"
    TOK_ACTION_TRANSFORMATION_BASE_64_DECODE = 465, // "ACTION_TRANSFORMATION_BASE_64_DECODE"
    TOK_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 466, // "ACTION_TRANSFORMATION_BASE_64_DECODE_EXT"
    TOK_ACTION_TRANSFORMATION_CMD_LINE = 467, // "ACTION_TRANSFORMATION_CMD_LINE"
    TOK_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 468, // "ACTION_TRANSFORMATION_COMPRESS_WHITESPACE"
    TOK_ACTION_TRANSFORMATION_CSS_DECODE = 469, // "ACTION_TRANSFORMATION_CSS_DECODE"
    TOK_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 470, // "ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE"
    TOK_ACTION_TRANSFORMATION_HEX_ENCODE = 471, // "ACTION_TRANSFORMATION_HEX_ENCODE"
    TOK_ACTION_TRANSFORMATION_HEX_DECODE = 472, // "ACTION_TRANSFORMATION_HEX_DECODE"
    TOK_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 473, // "ACTION_TRANSFORMATION_HTML_ENTITY_DECODE"
    TOK_ACTION_TRANSFORMATION_JS_DECODE = 474, // "ACTION_TRANSFORMATION_JS_DECODE"
    TOK_ACTION_TRANSFORMATION_LENGTH = 475, // "ACTION_TRANSFORMATION_LENGTH"
    TOK_ACTION_TRANSFORMATION_LOWERCASE = 476, // "ACTION_TRANSFORMATION_LOWERCASE"
    TOK_ACTION_TRANSFORMATION_MD5 = 477, // "ACTION_TRANSFORMATION_MD5"
    TOK_ACTION_TRANSFORMATION_NONE = 478, // "ACTION_TRANSFORMATION_NONE"
    TOK_ACTION_TRANSFORMATION_NORMALISE_PATH = 479, // "ACTION_TRANSFORMATION_NORMALISE_PATH"
    TOK_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 480, // "ACTION_TRANSFORMATION_NORMALISE_PATH_WIN"
    TOK_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 481, // "ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT"
    TOK_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 482, // "ACTION_TRANSFORMATION_PARITY_ODD_7_BIT"
    TOK_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 483, // "ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT"
    TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 484, // "ACTION_TRANSFORMATION_REMOVE_COMMENTS"
    TOK_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 485, // "ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR"
    TOK_ACTION_TRANSFORMATION_REMOVE_NULLS = 486, // "ACTION_TRANSFORMATION_REMOVE_NULLS"
    TOK_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 487, // "ACTION_TRANSFORMATION_REMOVE_WHITESPACE"
    TOK_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 488, // "ACTION_TRANSFORMATION_REPLACE_COMMENTS"
    TOK_ACTION_TRANSFORMATION_REPLACE_NULLS = 489, // "ACTION_TRANSFORMATION_REPLACE_NULLS"
    TOK_ACTION_TRANSFORMATION_SHA1 = 490, // "ACTION_TRANSFORMATION_SHA1"
    TOK_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 491, // "ACTION_TRANSFORMATION_SQL_HEX_DECODE"
    TOK_ACTION_TRANSFORMATION_TRIM = 492, // "ACTION_TRANSFORMATION_TRIM"
    TOK_ACTION_TRANSFORMATION_TRIM_LEFT = 493, // "ACTION_TRANSFORMATION_TRIM_LEFT"
    TOK_ACTION_TRANSFORMATION_TRIM_RIGHT = 494, // "ACTION_TRANSFORMATION_TRIM_RIGHT"
    TOK_ACTION_TRANSFORMATION_UPPERCASE = 495, // "ACTION_TRANSFORMATION_UPPERCASE"
    TOK_ACTION_TRANSFORMATION_URL_ENCODE = 496, // "ACTION_TRANSFORMATION_URL_ENCODE"
    TOK_ACTION_TRANSFORMATION_URL_DECODE = 497, // "ACTION_TRANSFORMATION_URL_DECODE"
    TOK_ACTION_TRANSFORMATION_URL_DECODE_UNI = 498, // "ACTION_TRANSFORMATION_URL_DECODE_UNI"
    TOK_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 499, // "ACTION_TRANSFORMATION_UTF8_TO_UNICODE"
    TOK_ACTION_VER = 500,          // "Ver"
    TOK_ACTION_XMLNS = 501,        // "xmlns"
    TOK_CONFIG_COMPONENT_SIG = 502, // "CONFIG_COMPONENT_SIG"
    TOK_CONFIG_CONN_ENGINE = 503,  // "CONFIG_CONN_ENGINE"
    TOK_CONFIG_SEC_ARGUMENT_SEPARATOR = 504, // "CONFIG_SEC_ARGUMENT_SEPARATOR"
    TOK_CONFIG_SEC_WEB_APP_ID = 505, // "CONFIG_SEC_WEB_APP_ID"
    TOK_CONFIG_SEC_SERVER_SIG = 506, // "CONFIG_SEC_SERVER_SIG"
    TOK_CONFIG_DIR_AUDIT_DIR = 507, // "CONFIG_DIR_AUDIT_DIR"
    TOK_CONFIG_DIR_AUDIT_DIR_MOD = 508, // "CONFIG_DIR_AUDIT_DIR_MOD"
    TOK_CONFIG_DIR_AUDIT_ENG = 509, // "CONFIG_DIR_AUDIT_ENG"
    TOK_CONFIG_DIR_AUDIT_FLE_MOD = 510, // "CONFIG_DIR_AUDIT_FLE_MOD"
    TOK_CONFIG_DIR_AUDIT_LOG = 511, // "CONFIG_DIR_AUDIT_LOG"
    TOK_CONFIG_DIR_AUDIT_LOG2 = 512, // "CONFIG_DIR_AUDIT_LOG2"
    TOK_CONFIG_DIR_AUDIT_LOG_P = 513, // "CONFIG_DIR_AUDIT_LOG_P"
    TOK_CONFIG_DIR_AUDIT_STS = 514, // "CONFIG_DIR_AUDIT_STS"
    TOK_CONFIG_DIR_AUDIT_PREFIX = 515, // "CONFIG_DIR_AUDIT_PREFIX"
    TOK_CONFIG_DIR_AUDIT_TPE = 516, // "CONFIG_DIR_AUDIT_TPE"
    TOK_CONFIG_DIR_DEBUG_LOG = 517, // "CONFIG_DIR_DEBUG_LOG"
    TOK_CONFIG_DIR_DEBUG_LVL = 518, // "CONFIG_DIR_DEBUG_LVL"
    TOK_CONFIG_SEC_CACHE_TRANSFORMATIONS = 519, // "CONFIG_SEC_CACHE_TRANSFORMATIONS"
    TOK_CONFIG_SEC_DISABLE_BACKEND_COMPRESS = 520, // "CONFIG_SEC_DISABLE_BACKEND_COMPRESS"
    TOK_CONFIG_SEC_HASH_ENGINE = 521, // "CONFIG_SEC_HASH_ENGINE"
    TOK_CONFIG_SEC_HASH_KEY = 522, // "CONFIG_SEC_HASH_KEY"
    TOK_CONFIG_SEC_HASH_PARAM = 523, // "CONFIG_SEC_HASH_PARAM"
    TOK_CONFIG_SEC_HASH_METHOD_RX = 524, // "CONFIG_SEC_HASH_METHOD_RX"
    TOK_CONFIG_SEC_HASH_METHOD_PM = 525, // "CONFIG_SEC_HASH_METHOD_PM"
    TOK_CONFIG_SEC_CHROOT_DIR = 526, // "CONFIG_SEC_CHROOT_DIR"
    TOK_CONFIG_DIR_GEO_DB = 527,   // "CONFIG_DIR_GEO_DB"
    TOK_CONFIG_DIR_GSB_DB = 528,   // "CONFIG_DIR_GSB_DB"
    TOK_CONFIG_SEC_GUARDIAN_LOG = 529, // "CONFIG_SEC_GUARDIAN_LOG"
    TOK_CONFIG_DIR_PCRE_MATCH_LIMIT = 530, // "CONFIG_DIR_PCRE_MATCH_LIMIT"
    TOK_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 531, // "CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION"
    TOK_CONFIG_SEC_CONN_R_STATE_LIMIT = 532, // "CONFIG_SEC_CONN_R_STATE_LIMIT"
    TOK_CONFIG_SEC_CONN_W_STATE_LIMIT = 533, // "CONFIG_SEC_CONN_W_STATE_LIMIT"
    TOK_CONFIG_SEC_SENSOR_ID = 534, // "CONFIG_SEC_SENSOR_ID"
    TOK_CONFIG_DIR_ARGS_LIMIT = 535, // "CONFIG_DIR_ARGS_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT = 536, // "CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY = 537, // "CONFIG_DIR_REQ_BODY"
    TOK_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 538, // "CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY_LIMIT = 539, // "CONFIG_DIR_REQ_BODY_LIMIT"
    TOK_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 540, // "CONFIG_DIR_REQ_BODY_LIMIT_ACTION"
    TOK_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 541, // "CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT"
    TOK_CONFIG_DIR_RES_BODY = 542, // "CONFIG_DIR_RES_BODY"
    TOK_CONFIG_DIR_RES_BODY_LIMIT = 543, // "CONFIG_DIR_RES_BODY_LIMIT"
    TOK_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 544, // "CONFIG_DIR_RES_BODY_LIMIT_ACTION"
    TOK_CONFIG_SEC_RULE_INHERITANCE = 545, // "CONFIG_SEC_RULE_INHERITANCE"
    TOK_CONFIG_SEC_RULE_PERF_TIME = 546, // "CONFIG_SEC_RULE_PERF_TIME"
    TOK_CONFIG_DIR_RULE_ENG = 547, // "CONFIG_DIR_RULE_ENG"
    TOK_CONFIG_DIR_SEC_ACTION = 548, // "CONFIG_DIR_SEC_ACTION"
    TOK_CONFIG_DIR_SEC_DEFAULT_ACTION = 549, // "CONFIG_DIR_SEC_DEFAULT_ACTION"
    TOK_CONFIG_DIR_SEC_MARKER = 550, // "CONFIG_DIR_SEC_MARKER"
    TOK_CONFIG_DIR_UNICODE_MAP_FILE = 551, // "CONFIG_DIR_UNICODE_MAP_FILE"
    TOK_CONFIG_DIR_UNICODE_CODE_PAGE = 552, // "CONFIG_DIR_UNICODE_CODE_PAGE"
    TOK_CONFIG_SEC_COLLECTION_TIMEOUT = 553, // "CONFIG_SEC_COLLECTION_TIMEOUT"
    TOK_CONFIG_SEC_HTTP_BLKEY = 554, // "CONFIG_SEC_HTTP_BLKEY"
    TOK_CONFIG_SEC_INTERCEPT_ON_ERROR = 555, // "CONFIG_SEC_INTERCEPT_ON_ERROR"
    TOK_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 556, // "CONFIG_SEC_REMOTE_RULES_FAIL_ACTION"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_ID = 557, // "CONFIG_SEC_RULE_REMOVE_BY_ID"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_MSG = 558, // "CONFIG_SEC_RULE_REMOVE_BY_MSG"
    TOK_CONFIG_SEC_RULE_REMOVE_BY_TAG = 559, // "CONFIG_SEC_RULE_REMOVE_BY_TAG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 560, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 561, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG"
    TOK_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 562, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID"
    TOK_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 563, // "CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID"
    TOK_CONFIG_UPDLOAD_KEEP_FILES = 564, // "CONFIG_UPDLOAD_KEEP_FILES"
    TOK_CONFIG_UPDLOAD_SAVE_TMP_FILES = 565, // "CONFIG_UPDLOAD_SAVE_TMP_FILES"
    TOK_CONFIG_UPLOAD_DIR = 566,   // "CONFIG_UPLOAD_DIR"
    TOK_CONFIG_UPLOAD_FILE_LIMIT = 567, // "CONFIG_UPLOAD_FILE_LIMIT"
    TOK_CONFIG_UPLOAD_FILE_MODE = 568, // "CONFIG_UPLOAD_FILE_MODE"
    TOK_CONFIG_VALUE_ABORT = 569,  // "CONFIG_VALUE_ABORT"
    TOK_CONFIG_VALUE_DETC = 570,   // "CONFIG_VALUE_DETC"
    TOK_CONFIG_VALUE_HTTPS = 571,  // "CONFIG_VALUE_HTTPS"
    TOK_CONFIG_VALUE_ONLYARGS = 572, // "CONFIG_VALUE_ONLYARGS"
    TOK_CONFIG_VALUE_OFF = 573,    // "CONFIG_VALUE_OFF"
    TOK_CONFIG_VALUE_ON = 574,     // "CONFIG_VALUE_ON"
    TOK_CONFIG_VALUE_PARALLEL = 575, // "CONFIG_VALUE_PARALLEL"
    TOK_CONFIG_VALUE_PROCESS_PARTIAL = 576, // "CONFIG_VALUE_PROCESS_PARTIAL"
    TOK_CONFIG_VALUE_REJECT = 577, // "CONFIG_VALUE_REJECT"
    TOK_CONFIG_VALUE_RELEVANT_ONLY = 578, // "CONFIG_VALUE_RELEVANT_ONLY"
    TOK_CONFIG_VALUE_SERIAL = 579, // "CONFIG_VALUE_SERIAL"
    TOK_CONFIG_VALUE_WARN = 580,   // "CONFIG_VALUE_WARN"
    TOK_CONFIG_XML_EXTERNAL_ENTITY = 581, // "CONFIG_XML_EXTERNAL_ENTITY"
    TOK_CONFIG_XML_PARSE_XML_INTO_ARGS = 582, // "CONFIG_XML_PARSE_XML_INTO_ARGS"
    TOK_CONGIG_DIR_RESPONSE_BODY_MP = 583, // "CONGIG_DIR_RESPONSE_BODY_MP"
    TOK_CONGIG_DIR_SEC_ARG_SEP = 584, // "CONGIG_DIR_SEC_ARG_SEP"
    TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 585, // "CONGIG_DIR_SEC_COOKIE_FORMAT"
    TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 586, // "CONFIG_SEC_COOKIEV0_SEPARATOR"
    TOK_CONGIG_DIR_SEC_DATA_DIR = 587, // "CONGIG_DIR_SEC_DATA_DIR"
    TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 588, // "CONGIG_DIR_SEC_STATUS_ENGINE"
    TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 589, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
    TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 590, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
    TOK_CONGIG_DIR_SEC_TMP_DIR = 591, // "CONGIG_DIR_SEC_TMP_DIR"
    TOK_DIRECTIVE = 592,           // "DIRECTIVE"
    TOK_DIRECTIVE_SECRULESCRIPT = 593, // "DIRECTIVE_SECRULESCRIPT"
    TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 594, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
    TOK_QUOTATION_MARK = 595,      // "QUOTATION_MARK"
    TOK_RUN_TIME_VAR_BLD = 596,    // "RUN_TIME_VAR_BLD"
    TOK_RUN_TIME_VAR_DUR = 597,    // "RUN_TIME_VAR_DUR"
    TOK_RUN_TIME_VAR_HSV = 598,    // "RUN_TIME_VAR_HSV"
    TOK_RUN_TIME_VAR_REMOTE_USER = 599, // "RUN_TIME_VAR_REMOTE_USER"
    TOK_RUN_TIME_VAR_TIME = 600,   // "RUN_TIME_VAR_TIME"
    TOK_RUN_TIME_VAR_TIME_DAY = 601, // "RUN_TIME_VAR_TIME_DAY"
    TOK_RUN_TIME_VAR_TIME_EPOCH = 602, // "RUN_TIME_VAR_TIME_EPOCH"
    TOK_RUN_TIME_VAR_TIME_HOUR = 603, // "RUN_TIME_VAR_TIME_HOUR"
    TOK_RUN_TIME_VAR_TIME_MIN = 604, // "RUN_TIME_VAR_TIME_MIN"
    TOK_RUN_TIME_VAR_TIME_MON = 605, // "RUN_TIME_VAR_TIME_MON"
    TOK_RUN_TIME_VAR_TIME_SEC = 606, // "RUN_TIME_VAR_TIME_SEC"
    TOK_RUN_TIME_VAR_TIME_WDAY = 607, // "RUN_TIME_VAR_TIME_WDAY"
    TOK_RUN_TIME_VAR_TIME_YEAR = 608, // "RUN_TIME_VAR_TIME_YEAR"
    TOK_VARIABLE = 609,            // "VARIABLE"
    TOK_DICT_ELEMENT = 610,        // "Dictionary element"
    TOK_DICT_ELEMENT_WITH_EQUALS = 611, // "Dictionary element, with equals"
    TOK_DICT_ELEMENT_REGEXP = 612  // "Dictionary element, selected by regexp"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_VARIABLE_ARGS_RAW = 11,                // VARIABLE_ARGS_RAW
        S_VARIABLE_ARGS_POST = 12,               // VARIABLE_ARGS_POST
        S_VARIABLE_ARGS_POST_RAW = 13,           // VARIABLE_ARGS_POST_RAW
        S_VARIABLE_ARGS_GET = 14,                // VARIABLE_ARGS_GET
        S_VARIABLE_ARGS_GET_RAW = 15,            // VARIABLE_ARGS_GET_RAW
        S_VARIABLE_FILES_SIZES = 16,             // VARIABLE_FILES_SIZES
        S_VARIABLE_FILES_NAMES = 17,             // VARIABLE_FILES_NAMES
        S_VARIABLE_FILES_TMP_CONTENT = 18,       // VARIABLE_FILES_TMP_CONTENT
        S_VARIABLE_MULTIPART_FILENAME = 19,      // VARIABLE_MULTIPART_FILENAME
        S_VARIABLE_MULTIPART_NAME = 20,          // VARIABLE_MULTIPART_NAME
        S_VARIABLE_MATCHED_VARS_NAMES = 21,      // VARIABLE_MATCHED_VARS_NAMES
        S_VARIABLE_MATCHED_VARS = 22,            // VARIABLE_MATCHED_VARS
        S_VARIABLE_FILES = 23,                   // VARIABLE_FILES
        S_VARIABLE_REQUEST_COOKIES = 24,         // VARIABLE_REQUEST_COOKIES
        S_VARIABLE_REQUEST_HEADERS = 25,         // VARIABLE_REQUEST_HEADERS
        S_VARIABLE_RESPONSE_HEADERS = 26,        // VARIABLE_RESPONSE_HEADERS
        S_VARIABLE_GEO = 27,                     // VARIABLE_GEO
        S_VARIABLE_REQUEST_COOKIES_NAMES = 28,   // VARIABLE_REQUEST_COOKIES_NAMES
        S_VARIABLE_MULTIPART_PART_HEADERS = 29,  // VARIABLE_MULTIPART_PART_HEADERS
        S_VARIABLE_ARGS_COMBINED_SIZE = 30,      // VARIABLE_ARGS_COMBINED_SIZE
        S_VARIABLE_ARGS_GET_NAMES = 31,          // VARIABLE_ARGS_GET_NAMES
        S_VARIABLE_ARGS_GET_NAMES_RAW = 32,      // VARIABLE_ARGS_GET_NAMES_RAW
        S_VARIABLE_RULE = 33,                    // VARIABLE_RULE
        S_VARIABLE_ARGS_NAMES = 34,              // "Variable ARGS_NAMES"
        S_VARIABLE_ARGS_NAMES_RAW = 35,          // VARIABLE_ARGS_NAMES_RAW
        S_VARIABLE_ARGS_POST_NAMES = 36,         // VARIABLE_ARGS_POST_NAMES
        S_VARIABLE_ARGS_POST_NAMES_RAW = 37,     // VARIABLE_ARGS_POST_NAMES_RAW
        S_VARIABLE_AUTH_TYPE = 38,               // "AUTH_TYPE"
        S_VARIABLE_FILES_COMBINED_SIZE = 39,     // "FILES_COMBINED_SIZE"
        S_VARIABLE_FILES_TMP_NAMES = 40,         // "FILES_TMPNAMES"
        S_VARIABLE_FULL_REQUEST = 41,            // "FULL_REQUEST"
        S_VARIABLE_FULL_REQUEST_LENGTH = 42,     // "FULL_REQUEST_LENGTH"
        S_VARIABLE_INBOUND_DATA_ERROR = 43,      // "INBOUND_DATA_ERROR"
        S_VARIABLE_MATCHED_VAR = 44,             // "MATCHED_VAR"
        S_VARIABLE_MATCHED_VAR_NAME = 45,        // "MATCHED_VAR_NAME"
        S_VARIABLE_MSC_PCRE_ERROR = 46,          // "MSC_PCRE_ERROR"
        S_VARIABLE_MSC_PCRE_LIMITS_EXCEEDED = 47, // "MSC_PCRE_LIMITS_EXCEEDED"
        S_VARIABLE_MULTIPART_BOUNDARY_QUOTED = 48, // VARIABLE_MULTIPART_BOUNDARY_QUOTED
        S_VARIABLE_MULTIPART_BOUNDARY_WHITESPACE = 49, // VARIABLE_MULTIPART_BOUNDARY_WHITESPACE
        S_VARIABLE_MULTIPART_CRLF_LF_LINES = 50, // "MULTIPART_CRLF_LF_LINES"
        S_VARIABLE_MULTIPART_DATA_AFTER = 51,    // "MULTIPART_DATA_AFTER"
        S_VARIABLE_MULTIPART_DATA_BEFORE = 52,   // VARIABLE_MULTIPART_DATA_BEFORE
        S_VARIABLE_MULTIPART_FILE_LIMIT_EXCEEDED = 53, // "MULTIPART_FILE_LIMIT_EXCEEDED"
        S_VARIABLE_MULTIPART_HEADER_FOLDING = 54, // "MULTIPART_HEADER_FOLDING"
        S_VARIABLE_MULTIPART_INVALID_HEADER_FOLDING = 55, // "MULTIPART_INVALID_HEADER_FOLDING"
        S_VARIABLE_MULTIPART_INVALID_PART = 56,  // VARIABLE_MULTIPART_INVALID_PART
        S_VARIABLE_MULTIPART_INVALID_QUOTING = 57, // "MULTIPART_INVALID_QUOTING"
        S_VARIABLE_MULTIPART_LF_LINE = 58,       // VARIABLE_MULTIPART_LF_LINE
        S_VARIABLE_MULTIPART_MISSING_SEMICOLON = 59, // VARIABLE_MULTIPART_MISSING_SEMICOLON
        S_VARIABLE_MULTIPART_SEMICOLON_MISSING = 60, // VARIABLE_MULTIPART_SEMICOLON_MISSING
        S_VARIABLE_MULTIPART_STRICT_ERROR = 61,  // "MULTIPART_STRICT_ERROR"
        S_VARIABLE_MULTIPART_UNMATCHED_BOUNDARY = 62, // "MULTIPART_UNMATCHED_BOUNDARY"
        S_VARIABLE_OUTBOUND_DATA_ERROR = 63,     // "OUTBOUND_DATA_ERROR"
        S_VARIABLE_PATH_INFO = 64,               // "PATH_INFO"
        S_VARIABLE_QUERY_STRING = 65,            // "QUERY_STRING"
        S_VARIABLE_REMOTE_ADDR = 66,             // "REMOTE_ADDR"
        S_VARIABLE_REMOTE_HOST = 67,             // "REMOTE_HOST"
        S_VARIABLE_REMOTE_PORT = 68,             // "REMOTE_PORT"
        S_VARIABLE_REQBODY_ERROR_MSG = 69,       // "REQBODY_ERROR_MSG"
        S_VARIABLE_REQBODY_ERROR = 70,           // "REQBODY_ERROR"
        S_VARIABLE_REQBODY_PROCESSOR_ERROR_MSG = 71, // "REQBODY_PROCESSOR_ERROR_MSG"
        S_VARIABLE_REQBODY_PROCESSOR_ERROR = 72, // "REQBODY_PROCESSOR_ERROR"
        S_VARIABLE_REQBODY_PROCESSOR = 73,       // "REQBODY_PROCESSOR"
        S_VARIABLE_REQUEST_BASENAME = 74,        // "REQUEST_BASENAME"
        S_VARIABLE_REQUEST_BODY_LENGTH = 75,     // "REQUEST_BODY_LENGTH"
        S_VARIABLE_REQUEST_BODY = 76,            // "REQUEST_BODY"
        S_VARIABLE_REQUEST_FILE_NAME = 77,       // "REQUEST_FILENAME"
        S_VARIABLE_REQUEST_HEADERS_NAMES = 78,   // VARIABLE_REQUEST_HEADERS_NAMES
        S_VARIABLE_REQUEST_LINE = 79,            // "REQUEST_LINE"
        S_VARIABLE_REQUEST_METHOD = 80,          // "REQUEST_METHOD"
        S_VARIABLE_REQUEST_PROTOCOL = 81,        // "REQUEST_PROTOCOL"
        S_VARIABLE_REQUEST_URI_RAW = 82,         // "REQUEST_URI_RAW"
        S_VARIABLE_REQUEST_URI = 83,             // "REQUEST_URI"
        S_VARIABLE_RESOURCE = 84,                // "RESOURCE"
        S_VARIABLE_RESPONSE_BODY = 85,           // "RESPONSE_BODY"
        S_VARIABLE_RESPONSE_CONTENT_LENGTH = 86, // "RESPONSE_CONTENT_LENGTH"
        S_VARIABLE_RESPONSE_CONTENT_TYPE = 87,   // VARIABLE_RESPONSE_CONTENT_TYPE
        S_VARIABLE_RESPONSE_HEADERS_NAMES = 88,  // VARIABLE_RESPONSE_HEADERS_NAMES
        S_VARIABLE_RESPONSE_PROTOCOL = 89,       // "RESPONSE_PROTOCOL"
        S_VARIABLE_RESPONSE_STATUS = 90,         // "RESPONSE_STATUS"
        S_VARIABLE_SERVER_ADDR = 91,             // "SERVER_ADDR"
        S_VARIABLE_SERVER_NAME = 92,             // "SERVER_NAME"
        S_VARIABLE_SERVER_PORT = 93,             // "SERVER_PORT"
        S_VARIABLE_SESSION_ID = 94,              // "SESSIONID"
        S_VARIABLE_UNIQUE_ID = 95,               // "UNIQUE_ID"
        S_VARIABLE_URL_ENCODED_ERROR = 96,       // "URLENCODED_ERROR"
        S_VARIABLE_USER_ID = 97,                 // "USERID"
        S_VARIABLE_WEB_APP_ID = 98,              // "WEBAPPID"
        S_VARIABLE_STATUS = 99,                  // "VARIABLE_STATUS"
        S_VARIABLE_STATUS_LINE = 100,            // "VARIABLE_STATUS_LINE"
        S_VARIABLE_IP = 101,                     // "VARIABLE_IP"
        S_VARIABLE_GLOBAL = 102,                 // "VARIABLE_GLOBAL"
        S_VARIABLE_TX = 103,                     // "VARIABLE_TX"
        S_VARIABLE_SESSION = 104,                // "VARIABLE_SESSION"
        S_VARIABLE_USER = 105,                   // "VARIABLE_USER"
        S_RUN_TIME_VAR_ENV = 106,                // "RUN_TIME_VAR_ENV"
        S_RUN_TIME_VAR_XML = 107,                // "RUN_TIME_VAR_XML"
        S_ACTION_SETVAR = 108,                   // "SetVar"
        S_SETVAR_OPERATION_EQUALS = 109,         // SETVAR_OPERATION_EQUALS
        S_SETVAR_OPERATION_EQUALS_PLUS = 110,    // SETVAR_OPERATION_EQUALS_PLUS
        S_SETVAR_OPERATION_EQUALS_MINUS = 111,   // SETVAR_OPERATION_EQUALS_MINUS
        S_NOT = 112,                             // "NOT"
        S_OPERATOR_BEGINS_WITH = 113,            // "OPERATOR_BEGINS_WITH"
        S_OPERATOR_CONTAINS = 114,               // "OPERATOR_CONTAINS"
        S_OPERATOR_CONTAINS_WORD = 115,          // "OPERATOR_CONTAINS_WORD"
        S_OPERATOR_DETECT_SQLI = 116,            // "OPERATOR_DETECT_SQLI"
        S_OPERATOR_DETECT_XSS = 117,             // "OPERATOR_DETECT_XSS"
        S_OPERATOR_ENDS_WITH = 118,              // "OPERATOR_ENDS_WITH"
        S_OPERATOR_EQ = 119,                     // "OPERATOR_EQ"
        S_OPERATOR_FUZZY_HASH = 120,             // "OPERATOR_FUZZY_HASH"
        S_OPERATOR_GEOLOOKUP = 121,              // "OPERATOR_GEOLOOKUP"
        S_OPERATOR_GE = 122,                     // "OPERATOR_GE"
        S_OPERATOR_GSB_LOOKUP = 123,             // "OPERATOR_GSB_LOOKUP"
        S_OPERATOR_GT = 124,                     // "OPERATOR_GT"
        S_OPERATOR_INSPECT_FILE = 125,           // "OPERATOR_INSPECT_FILE"
        S_OPERATOR_IP_MATCH_FROM_FILE = 126,     // "OPERATOR_IP_MATCH_FROM_FILE"
        S_OPERATOR_IP_MATCH = 127,               // "OPERATOR_IP_MATCH"
        S_OPERATOR_LE = 128,                     // "OPERATOR_LE"
        S_OPERATOR_LT = 129,                     // "OPERATOR_LT"
        S_OPERATOR_PM_FROM_FILE = 130,           // "OPERATOR_PM_FROM_FILE"
        S_OPERATOR_PM = 131,                     // "OPERATOR_PM"
        S_OPERATOR_RBL = 132,                    // "OPERATOR_RBL"
        S_OPERATOR_RSUB = 133,                   // "OPERATOR_RSUB"
        S_OPERATOR_RX_CONTENT_ONLY = 134,        // "Operator RX (content only)"
        S_OPERATOR_RX = 135,                     // "OPERATOR_RX"
        S_OPERATOR_RX_GLOBAL = 136,              // "OPERATOR_RX_GLOBAL"
        S_OPERATOR_STR_EQ = 137,                 // "OPERATOR_STR_EQ"
        S_OPERATOR_STR_MATCH = 138,              // "OPERATOR_STR_MATCH"
        S_OPERATOR_UNCONDITIONAL_MATCH = 139,    // "OPERATOR_UNCONDITIONAL_MATCH"
        S_OPERATOR_VALIDATE_BYTE_RANGE = 140,    // "OPERATOR_VALIDATE_BYTE_RANGE"
        S_OPERATOR_VALIDATE_DTD = 141,           // "OPERATOR_VALIDATE_DTD"
        S_OPERATOR_VALIDATE_HASH = 142,          // "OPERATOR_VALIDATE_HASH"
        S_OPERATOR_VALIDATE_SCHEMA = 143,        // "OPERATOR_VALIDATE_SCHEMA"
        S_OPERATOR_VALIDATE_URL_ENCODING = 144,  // "OPERATOR_VALIDATE_URL_ENCODING"
        S_OPERATOR_VALIDATE_UTF8_ENCODING = 145, // "OPERATOR_VALIDATE_UTF8_ENCODING"
        S_OPERATOR_VERIFY_CC = 146,              // "OPERATOR_VERIFY_CC"
        S_OPERATOR_VERIFY_CPF = 147,             // "OPERATOR_VERIFY_CPF"
        S_OPERATOR_VERIFY_SSN = 148,             // "OPERATOR_VERIFY_SSN"
        S_OPERATOR_VERIFY_SVNR = 149,            // "OPERATOR_VERIFY_SVNR"
        S_OPERATOR_WITHIN = 150,                 // "OPERATOR_WITHIN"
        S_CONFIG_DIR_AUDIT_LOG_FMT = 151,        // CONFIG_DIR_AUDIT_LOG_FMT
        S_JSON = 152,                            // JSON
        S_NATIVE = 153,                          // NATIVE
        S_ACTION_CTL_RULE_ENGINE = 154,          // "ACTION_CTL_RULE_ENGINE"
        S_ACTION_ACCURACY = 155,                 // "Accuracy"
        S_ACTION_ALLOW = 156,                    // "Allow"
        S_ACTION_APPEND = 157,                   // "Append"
        S_ACTION_AUDIT_LOG = 158,                // "AuditLog"
        S_ACTION_BLOCK = 159,                    // "Block"
        S_ACTION_CAPTURE = 160,                  // "Capture"
        S_ACTION_CHAIN = 161,                    // "Chain"
        S_ACTION_CTL_AUDIT_ENGINE = 162,         // "ACTION_CTL_AUDIT_ENGINE"
        S_ACTION_CTL_AUDIT_LOG_PARTS = 163,      // "ACTION_CTL_AUDIT_LOG_PARTS"
        S_ACTION_CTL_BDY_JSON = 164,             // "ACTION_CTL_BDY_JSON"
        S_ACTION_CTL_BDY_XML = 165,              // "ACTION_CTL_BDY_XML"
        S_ACTION_CTL_BDY_URLENCODED = 166,       // "ACTION_CTL_BDY_URLENCODED"
        S_ACTION_CTL_FORCE_REQ_BODY_VAR = 167,   // "ACTION_CTL_FORCE_REQ_BODY_VAR"
        S_ACTION_CTL_PARSE_XML_INTO_ARGS = 168,  // "ACTION_CTL_PARSE_XML_INTO_ARGS"
        S_ACTION_CTL_REQUEST_BODY_ACCESS = 169,  // "ACTION_CTL_REQUEST_BODY_ACCESS"
        S_ACTION_CTL_RULE_REMOVE_BY_ID = 170,    // "ACTION_CTL_RULE_REMOVE_BY_ID"
        S_ACTION_CTL_RULE_REMOVE_BY_TAG = 171,   // "ACTION_CTL_RULE_REMOVE_BY_TAG"
        S_ACTION_CTL_RULE_REMOVE_TARGET_BY_ID = 172, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_ID"
        S_ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG = 173, // "ACTION_CTL_RULE_REMOVE_TARGET_BY_TAG"
        S_ACTION_DENY = 174,                     // "Deny"
        S_ACTION_DEPRECATE_VAR = 175,            // "DeprecateVar"
        S_ACTION_DROP = 176,                     // "Drop"
        S_ACTION_EXEC = 177,                     // "Exec"
        S_ACTION_EXPIRE_VAR = 178,               // "ExpireVar"
        S_ACTION_ID = 179,                       // "Id"
        S_ACTION_INITCOL = 180,                  // "InitCol"
        S_ACTION_LOG = 181,                      // "Log"
        S_ACTION_LOG_DATA = 182,                 // "LogData"
        S_ACTION_MATURITY = 183,                 // "Maturity"
        S_ACTION_MSG = 184,                      // "Msg"
        S_ACTION_MULTI_MATCH = 185,              // "MultiMatch"
        S_ACTION_NO_AUDIT_LOG = 186,             // "NoAuditLog"
        S_ACTION_NO_LOG = 187,                   // "NoLog"
        S_ACTION_PASS = 188,                     // "Pass"
        S_ACTION_PAUSE = 189,                    // "Pause"
        S_ACTION_PHASE = 190,                    // "Phase"
        S_ACTION_PREPEND = 191,                  // "Prepend"
        S_ACTION_PROXY = 192,                    // "Proxy"
        S_ACTION_REDIRECT = 193,                 // "Redirect"
        S_ACTION_REV = 194,                      // "Rev"
        S_ACTION_SANITISE_ARG = 195,             // "SanitiseArg"
        S_ACTION_SANITISE_MATCHED = 196,         // "SanitiseMatched"
        S_ACTION_SANITISE_MATCHED_BYTES = 197,   // "SanitiseMatchedBytes"
        S_ACTION_SANITISE_REQUEST_HEADER = 198,  // "SanitiseRequestHeader"
        S_ACTION_SANITISE_RESPONSE_HEADER = 199, // "SanitiseResponseHeader"
        S_ACTION_SETENV = 200,                   // "SetEnv"
        S_ACTION_SETRSC = 201,                   // "SetRsc"
        S_ACTION_SETSID = 202,                   // "SetSid"
        S_ACTION_SETUID = 203,                   // "SetUID"
        S_ACTION_SEVERITY = 204,                 // "Severity"
        S_ACTION_SKIP = 205,                     // "Skip"
        S_ACTION_SKIP_AFTER = 206,               // "SkipAfter"
        S_ACTION_STATUS = 207,                   // "Status"
        S_ACTION_TAG = 208,                      // "Tag"
        S_ACTION_TRANSFORMATION_BASE_64_ENCODE = 209, // "ACTION_TRANSFORMATION_BASE_64_ENCODE"
        S_ACTION_TRANSFORMATION_BASE_64_DECODE = 210, // "ACTION_TRANSFORMATION_BASE_64_DECODE"
        S_ACTION_TRANSFORMATION_BASE_64_DECODE_EXT = 211, // "ACTION_TRANSFORMATION_BASE_64_DECODE_EXT"
        S_ACTION_TRANSFORMATION_CMD_LINE = 212,  // "ACTION_TRANSFORMATION_CMD_LINE"
        S_ACTION_TRANSFORMATION_COMPRESS_WHITESPACE = 213, // "ACTION_TRANSFORMATION_COMPRESS_WHITESPACE"
        S_ACTION_TRANSFORMATION_CSS_DECODE = 214, // "ACTION_TRANSFORMATION_CSS_DECODE"
        S_ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE = 215, // "ACTION_TRANSFORMATION_ESCAPE_SEQ_DECODE"
        S_ACTION_TRANSFORMATION_HEX_ENCODE = 216, // "ACTION_TRANSFORMATION_HEX_ENCODE"
        S_ACTION_TRANSFORMATION_HEX_DECODE = 217, // "ACTION_TRANSFORMATION_HEX_DECODE"
        S_ACTION_TRANSFORMATION_HTML_ENTITY_DECODE = 218, // "ACTION_TRANSFORMATION_HTML_ENTITY_DECODE"
        S_ACTION_TRANSFORMATION_JS_DECODE = 219, // "ACTION_TRANSFORMATION_JS_DECODE"
        S_ACTION_TRANSFORMATION_LENGTH = 220,    // "ACTION_TRANSFORMATION_LENGTH"
        S_ACTION_TRANSFORMATION_LOWERCASE = 221, // "ACTION_TRANSFORMATION_LOWERCASE"
        S_ACTION_TRANSFORMATION_MD5 = 222,       // "ACTION_TRANSFORMATION_MD5"
        S_ACTION_TRANSFORMATION_NONE = 223,      // "ACTION_TRANSFORMATION_NONE"
        S_ACTION_TRANSFORMATION_NORMALISE_PATH = 224, // "ACTION_TRANSFORMATION_NORMALISE_PATH"
        S_ACTION_TRANSFORMATION_NORMALISE_PATH_WIN = 225, // "ACTION_TRANSFORMATION_NORMALISE_PATH_WIN"
        S_ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT = 226, // "ACTION_TRANSFORMATION_PARITY_EVEN_7_BIT"
        S_ACTION_TRANSFORMATION_PARITY_ODD_7_BIT = 227, // "ACTION_TRANSFORMATION_PARITY_ODD_7_BIT"
        S_ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT = 228, // "ACTION_TRANSFORMATION_PARITY_ZERO_7_BIT"
        S_ACTION_TRANSFORMATION_REMOVE_COMMENTS = 229, // "ACTION_TRANSFORMATION_REMOVE_COMMENTS"
        S_ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR = 230, // "ACTION_TRANSFORMATION_REMOVE_COMMENTS_CHAR"
        S_ACTION_TRANSFORMATION_REMOVE_NULLS = 231, // "ACTION_TRANSFORMATION_REMOVE_NULLS"
        S_ACTION_TRANSFORMATION_REMOVE_WHITESPACE = 232, // "ACTION_TRANSFORMATION_REMOVE_WHITESPACE"
        S_ACTION_TRANSFORMATION_REPLACE_COMMENTS = 233, // "ACTION_TRANSFORMATION_REPLACE_COMMENTS"
        S_ACTION_TRANSFORMATION_REPLACE_NULLS = 234, // "ACTION_TRANSFORMATION_REPLACE_NULLS"
        S_ACTION_TRANSFORMATION_SHA1 = 235,      // "ACTION_TRANSFORMATION_SHA1"
        S_ACTION_TRANSFORMATION_SQL_HEX_DECODE = 236, // "ACTION_TRANSFORMATION_SQL_HEX_DECODE"
        S_ACTION_TRANSFORMATION_TRIM = 237,      // "ACTION_TRANSFORMATION_TRIM"
        S_ACTION_TRANSFORMATION_TRIM_LEFT = 238, // "ACTION_TRANSFORMATION_TRIM_LEFT"
        S_ACTION_TRANSFORMATION_TRIM_RIGHT = 239, // "ACTION_TRANSFORMATION_TRIM_RIGHT"
        S_ACTION_TRANSFORMATION_UPPERCASE = 240, // "ACTION_TRANSFORMATION_UPPERCASE"
        S_ACTION_TRANSFORMATION_URL_ENCODE = 241, // "ACTION_TRANSFORMATION_URL_ENCODE"
        S_ACTION_TRANSFORMATION_URL_DECODE = 242, // "ACTION_TRANSFORMATION_URL_DECODE"
        S_ACTION_TRANSFORMATION_URL_DECODE_UNI = 243, // "ACTION_TRANSFORMATION_URL_DECODE_UNI"
        S_ACTION_TRANSFORMATION_UTF8_TO_UNICODE = 244, // "ACTION_TRANSFORMATION_UTF8_TO_UNICODE"
        S_ACTION_VER = 245,                      // "Ver"
        S_ACTION_XMLNS = 246,                    // "xmlns"
        S_CONFIG_COMPONENT_SIG = 247,            // "CONFIG_COMPONENT_SIG"
        S_CONFIG_CONN_ENGINE = 248,              // "CONFIG_CONN_ENGINE"
        S_CONFIG_SEC_ARGUMENT_SEPARATOR = 249,   // "CONFIG_SEC_ARGUMENT_SEPARATOR"
        S_CONFIG_SEC_WEB_APP_ID = 250,           // "CONFIG_SEC_WEB_APP_ID"
        S_CONFIG_SEC_SERVER_SIG = 251,           // "CONFIG_SEC_SERVER_SIG"
        S_CONFIG_DIR_AUDIT_DIR = 252,            // "CONFIG_DIR_AUDIT_DIR"
        S_CONFIG_DIR_AUDIT_DIR_MOD = 253,        // "CONFIG_DIR_AUDIT_DIR_MOD"
        S_CONFIG_DIR_AUDIT_ENG = 254,            // "CONFIG_DIR_AUDIT_ENG"
        S_CONFIG_DIR_AUDIT_FLE_MOD = 255,        // "CONFIG_DIR_AUDIT_FLE_MOD"
        S_CONFIG_DIR_AUDIT_LOG = 256,            // "CONFIG_DIR_AUDIT_LOG"
        S_CONFIG_DIR_AUDIT_LOG2 = 257,           // "CONFIG_DIR_AUDIT_LOG2"
        S_CONFIG_DIR_AUDIT_LOG_P = 258,          // "CONFIG_DIR_AUDIT_LOG_P"
        S_CONFIG_DIR_AUDIT_STS = 259,            // "CONFIG_DIR_AUDIT_STS"
        S_CONFIG_DIR_AUDIT_PREFIX = 260,         // "CONFIG_DIR_AUDIT_PREFIX"
        S_CONFIG_DIR_AUDIT_TPE = 261,            // "CONFIG_DIR_AUDIT_TPE"
        S_CONFIG_DIR_DEBUG_LOG = 262,            // "CONFIG_DIR_DEBUG_LOG"
        S_CONFIG_DIR_DEBUG_LVL = 263,            // "CONFIG_DIR_DEBUG_LVL"
        S_CONFIG_SEC_CACHE_TRANSFORMATIONS = 264, // "CONFIG_SEC_CACHE_TRANSFORMATIONS"
        S_CONFIG_SEC_DISABLE_BACKEND_COMPRESS = 265, // "CONFIG_SEC_DISABLE_BACKEND_COMPRESS"
        S_CONFIG_SEC_HASH_ENGINE = 266,          // "CONFIG_SEC_HASH_ENGINE"
        S_CONFIG_SEC_HASH_KEY = 267,             // "CONFIG_SEC_HASH_KEY"
        S_CONFIG_SEC_HASH_PARAM = 268,           // "CONFIG_SEC_HASH_PARAM"
        S_CONFIG_SEC_HASH_METHOD_RX = 269,       // "CONFIG_SEC_HASH_METHOD_RX"
        S_CONFIG_SEC_HASH_METHOD_PM = 270,       // "CONFIG_SEC_HASH_METHOD_PM"
        S_CONFIG_SEC_CHROOT_DIR = 271,           // "CONFIG_SEC_CHROOT_DIR"
        S_CONFIG_DIR_GEO_DB = 272,               // "CONFIG_DIR_GEO_DB"
        S_CONFIG_DIR_GSB_DB = 273,               // "CONFIG_DIR_GSB_DB"
        S_CONFIG_SEC_GUARDIAN_LOG = 274,         // "CONFIG_SEC_GUARDIAN_LOG"
        S_CONFIG_DIR_PCRE_MATCH_LIMIT = 275,     // "CONFIG_DIR_PCRE_MATCH_LIMIT"
        S_CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION = 276, // "CONFIG_DIR_PCRE_MATCH_LIMIT_RECURSION"
        S_CONFIG_SEC_CONN_R_STATE_LIMIT = 277,   // "CONFIG_SEC_CONN_R_STATE_LIMIT"
        S_CONFIG_SEC_CONN_W_STATE_LIMIT = 278,   // "CONFIG_SEC_CONN_W_STATE_LIMIT"
        S_CONFIG_SEC_SENSOR_ID = 279,            // "CONFIG_SEC_SENSOR_ID"
        S_CONFIG_DIR_ARGS_LIMIT = 280,           // "CONFIG_DIR_ARGS_LIMIT"
        S_CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT = 281, // "CONFIG_DIR_REQ_BODY_JSON_DEPTH_LIMIT"
        S_CONFIG_DIR_REQ_BODY = 282,             // "CONFIG_DIR_REQ_BODY"
        S_CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT = 283, // "CONFIG_DIR_REQ_BODY_IN_MEMORY_LIMIT"
        S_CONFIG_DIR_REQ_BODY_LIMIT = 284,       // "CONFIG_DIR_REQ_BODY_LIMIT"
        S_CONFIG_DIR_REQ_BODY_LIMIT_ACTION = 285, // "CONFIG_DIR_REQ_BODY_LIMIT_ACTION"
        S_CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT = 286, // "CONFIG_DIR_REQ_BODY_NO_FILES_LIMIT"
        S_CONFIG_DIR_RES_BODY = 287,             // "CONFIG_DIR_RES_BODY"
        S_CONFIG_DIR_RES_BODY_LIMIT = 288,       // "CONFIG_DIR_RES_BODY_LIMIT"
        S_CONFIG_DIR_RES_BODY_LIMIT_ACTION = 289, // "CONFIG_DIR_RES_BODY_LIMIT_ACTION"
        S_CONFIG_SEC_RULE_INHERITANCE = 290,     // "CONFIG_SEC_RULE_INHERITANCE"
        S_CONFIG_SEC_RULE_PERF_TIME = 291,       // "CONFIG_SEC_RULE_PERF_TIME"
        S_CONFIG_DIR_RULE_ENG = 292,             // "CONFIG_DIR_RULE_ENG"
        S_CONFIG_DIR_SEC_ACTION = 293,           // "CONFIG_DIR_SEC_ACTION"
        S_CONFIG_DIR_SEC_DEFAULT_ACTION = 294,   // "CONFIG_DIR_SEC_DEFAULT_ACTION"
        S_CONFIG_DIR_SEC_MARKER = 295,           // "CONFIG_DIR_SEC_MARKER"
        S_CONFIG_DIR_UNICODE_MAP_FILE = 296,     // "CONFIG_DIR_UNICODE_MAP_FILE"
        S_CONFIG_DIR_UNICODE_CODE_PAGE = 297,    // "CONFIG_DIR_UNICODE_CODE_PAGE"
        S_CONFIG_SEC_COLLECTION_TIMEOUT = 298,   // "CONFIG_SEC_COLLECTION_TIMEOUT"
        S_CONFIG_SEC_HTTP_BLKEY = 299,           // "CONFIG_SEC_HTTP_BLKEY"
        S_CONFIG_SEC_INTERCEPT_ON_ERROR = 300,   // "CONFIG_SEC_INTERCEPT_ON_ERROR"
        S_CONFIG_SEC_REMOTE_RULES_FAIL_ACTION = 301, // "CONFIG_SEC_REMOTE_RULES_FAIL_ACTION"
        S_CONFIG_SEC_RULE_REMOVE_BY_ID = 302,    // "CONFIG_SEC_RULE_REMOVE_BY_ID"
        S_CONFIG_SEC_RULE_REMOVE_BY_MSG = 303,   // "CONFIG_SEC_RULE_REMOVE_BY_MSG"
        S_CONFIG_SEC_RULE_REMOVE_BY_TAG = 304,   // "CONFIG_SEC_RULE_REMOVE_BY_TAG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG = 305, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_TAG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG = 306, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_MSG"
        S_CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID = 307, // "CONFIG_SEC_RULE_UPDATE_TARGET_BY_ID"
        S_CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID = 308, // "CONFIG_SEC_RULE_UPDATE_ACTION_BY_ID"
        S_CONFIG_UPDLOAD_KEEP_FILES = 309,       // "CONFIG_UPDLOAD_KEEP_FILES"
        S_CONFIG_UPDLOAD_SAVE_TMP_FILES = 310,   // "CONFIG_UPDLOAD_SAVE_TMP_FILES"
        S_CONFIG_UPLOAD_DIR = 311,               // "CONFIG_UPLOAD_DIR"
        S_CONFIG_UPLOAD_FILE_LIMIT = 312,        // "CONFIG_UPLOAD_FILE_LIMIT"
        S_CONFIG_UPLOAD_FILE_MODE = 313,         // "CONFIG_UPLOAD_FILE_MODE"
        S_CONFIG_VALUE_ABORT = 314,              // "CONFIG_VALUE_ABORT"
        S_CONFIG_VALUE_DETC = 315,               // "CONFIG_VALUE_DETC"
        S_CONFIG_VALUE_HTTPS = 316,              // "CONFIG_VALUE_HTTPS"
        S_CONFIG_VALUE_ONLYARGS = 317,           // "CONFIG_VALUE_ONLYARGS"
        S_CONFIG_VALUE_OFF = 318,                // "CONFIG_VALUE_OFF"
        S_CONFIG_VALUE_ON = 319,                 // "CONFIG_VALUE_ON"
        S_CONFIG_VALUE_PARALLEL = 320,           // "CONFIG_VALUE_PARALLEL"
        S_CONFIG_VALUE_PROCESS_PARTIAL = 321,    // "CONFIG_VALUE_PROCESS_PARTIAL"
        S_CONFIG_VALUE_REJECT = 322,             // "CONFIG_VALUE_REJECT"
        S_CONFIG_VALUE_RELEVANT_ONLY = 323,      // "CONFIG_VALUE_RELEVANT_ONLY"
        S_CONFIG_VALUE_SERIAL = 324,             // "CONFIG_VALUE_SERIAL"
        S_CONFIG_VALUE_WARN = 325,               // "CONFIG_VALUE_WARN"
        S_CONFIG_XML_EXTERNAL_ENTITY = 326,      // "CONFIG_XML_EXTERNAL_ENTITY"
        S_CONFIG_XML_PARSE_XML_INTO_ARGS = 327,  // "CONFIG_XML_PARSE_XML_INTO_ARGS"
        S_CONGIG_DIR_RESPONSE_BODY_MP = 328,     // "CONGIG_DIR_RESPONSE_BODY_MP"
        S_CONGIG_DIR_SEC_ARG_SEP = 329,          // "CONGIG_DIR_SEC_ARG_SEP"
        S_CONGIG_DIR_SEC_COOKIE_FORMAT = 330,    // "CONGIG_DIR_SEC_COOKIE_FORMAT"
        S_CONFIG_SEC_COOKIEV0_SEPARATOR = 331,   // "CONFIG_SEC_COOKIEV0_SEPARATOR"
        S_CONGIG_DIR_SEC_DATA_DIR = 332,         // "CONGIG_DIR_SEC_DATA_DIR"
        S_CONGIG_DIR_SEC_STATUS_ENGINE = 333,    // "CONGIG_DIR_SEC_STATUS_ENGINE"
        S_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 334, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
        S_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 335, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
        S_CONGIG_DIR_SEC_TMP_DIR = 336,          // "CONGIG_DIR_SEC_TMP_DIR"
        S_DIRECTIVE = 337,                       // "DIRECTIVE"
        S_DIRECTIVE_SECRULESCRIPT = 338,         // "DIRECTIVE_SECRULESCRIPT"
        S_FREE_TEXT_QUOTE_MACRO_EXPANSION = 339, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
        S_QUOTATION_MARK = 340,                  // "QUOTATION_MARK"
        S_RUN_TIME_VAR_BLD = 341,                // "RUN_TIME_VAR_BLD"
        S_RUN_TIME_VAR_DUR = 342,                // "RUN_TIME_VAR_DUR"
        S_RUN_TIME_VAR_HSV = 343,                // "RUN_TIME_VAR_HSV"
        S_RUN_TIME_VAR_REMOTE_USER = 344,        // "RUN_TIME_VAR_REMOTE_USER"
        S_RUN_TIME_VAR_TIME = 345,               // "RUN_TIME_VAR_TIME"
        S_RUN_TIME_VAR_TIME_DAY = 346,           // "RUN_TIME_VAR_TIME_DAY"
        S_RUN_TIME_VAR_TIME_EPOCH = 347,         // "RUN_TIME_VAR_TIME_EPOCH"
        S_RUN_TIME_VAR_TIME_HOUR = 348,          // "RUN_TIME_VAR_TIME_HOUR"
        S_RUN_TIME_VAR_TIME_MIN = 349,           // "RUN_TIME_VAR_TIME_MIN"
        S_RUN_TIME_VAR_TIME_MON = 350,           // "RUN_TIME_VAR_TIME_MON"
        S_RUN_TIME_VAR_TIME_SEC = 351,           // "RUN_TIME_VAR_TIME_SEC"
        S_RUN_TIME_VAR_TIME_WDAY = 352,          // "RUN_TIME_VAR_TIME_WDAY"
        S_RUN_TIME_VAR_TIME_YEAR = 353,          // "RUN_TIME_VAR_TIME_YEAR"
        S_VARIABLE = 354,                        // "VARIABLE"
        S_DICT_ELEMENT = 355,                    // "Dictionary element"
        S_DICT_ELEMENT_WITH_EQUALS = 356,        // "Dictionary element, with equals"
        S_DICT_ELEMENT_REGEXP = 357,             // "Dictionary element, selected by regexp"
        S_YYACCEPT = 358,                        // $accept
        S_input = 359,                           // input
        S_line = 360,                            // line
        S_audit_log = 361,                       // audit_log
        S_actions = 362,                         // actions
        S_actions_may_quoted = 363,              // actions_may_quoted
        S_op = 364,                              // op
        S_op_before_init = 365,                  // op_before_init
        S_expression = 366,                      // expression
        S_variables = 367,                       // variables
        S_variables_pre_process = 368,           // variables_pre_process
        S_variables_may_be_quoted = 369,         // variables_may_be_quoted
        S_var = 370,                             // var
        S_act = 371,                             // act
        S_setvar_action = 372,                   // setvar_action
        S_run_time_string = 373                  // run_time_string
      };
    };
...
#line 734 "seclang-parser.yy"
                    { }
#line 2211 "seclang-parser.hh"
        break;

      case symbol_kind::S_setvar_action: // setvar_action
#line 734 "seclang-parser.yy"
                    { }
#line 2217 "seclang-parser.hh"
        break;

      case symbol_kind::S_run_time_string: // run_time_string
#line 735 "seclang-parser.yy"
                    { }
#line 2223 "seclang-parser.hh"
        break;
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_POST_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_POST_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_POST_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_POST_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_GET_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_GET_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_GET_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_GET_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_GET_NAMES_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_GET_NAMES_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_GET_NAMES_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_GET_NAMES_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_NAMES_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_NAMES_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_NAMES_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_NAMES_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VARIABLE_ARGS_POST_NAMES_RAW (location_type l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_POST_NAMES_RAW, std::move (l));
      }
#else
      static
      symbol_type
      make_VARIABLE_ARGS_POST_NAMES_RAW (const location_type& l)
      {
        return symbol_type (token::TOK_VARIABLE_ARGS_POST_NAMES_RAW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    enum
    {
      yylast_ = 3517,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyfinal_ = 353 ///< Termination state number.
    };
