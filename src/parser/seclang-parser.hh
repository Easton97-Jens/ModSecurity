...
#ifndef YY_YY_SRC_PARSER_SECLANG_PARSER_HH_INCLUDED
# define YY_YY_SRC_PARSER_SECLANG_PARSER_HH_INCLUDED
// "%code requires" blocks.
#line 10 "src/parser/seclang-parser.yy"
...
#line 360 "src/parser/seclang-parser.hh"
...
namespace yy {
#line 500 "src/parser/seclang-parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // "CONFIG_DIR_AUDIT_STORAGE_DIR_MODE"
    ...
    TOK_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE = 503, // "CONFIG_DIR_AUDIT_STORAGE_DIR_MODE"
    ...
    TOK_CONFIG_VALUE_DAY = 568,    // "CONFIG_VALUE_DAY"
    TOK_CONFIG_VALUE_HOUR = 569,   // "CONFIG_VALUE_HOUR"
    TOK_CONFIG_VALUE_MINUTE = 570, // "CONFIG_VALUE_MINUTE"
    TOK_CONFIG_VALUE_SECOND = 571, // "CONFIG_VALUE_SECOND"
    TOK_CONFIG_VALUE_OFF = 572,    // "CONFIG_VALUE_OFF"
    TOK_CONFIG_VALUE_ON = 573,     // "CONFIG_VALUE_ON"
    TOK_CONFIG_VALUE_PARALLEL = 574, // "CONFIG_VALUE_PARALLEL"
    TOK_CONFIG_VALUE_PROCESS_PARTIAL = 575, // "CONFIG_VALUE_PROCESS_PARTIAL"
    TOK_CONFIG_VALUE_REJECT = 576, // "CONFIG_VALUE_REJECT"
    TOK_CONFIG_VALUE_RELEVANT_ONLY = 577, // "CONFIG_VALUE_RELEVANT_ONLY"
    TOK_CONFIG_VALUE_SERIAL = 578, // "CONFIG_VALUE_SERIAL"
    TOK_CONFIG_VALUE_WARN = 579,   // "CONFIG_VALUE_WARN"
    TOK_CONFIG_XML_EXTERNAL_ENTITY = 580, // "CONFIG_XML_EXTERNAL_ENTITY"
    TOK_CONFIG_XML_PARSE_XML_INTO_ARGS = 581, // "CONFIG_XML_PARSE_XML_INTO_ARGS"
    TOK_CONGIG_DIR_RESPONSE_BODY_MP = 582, // "CONGIG_DIR_RESPONSE_BODY_MP"
    TOK_CONGIG_DIR_SEC_ARG_SEP = 583, // "CONGIG_DIR_SEC_ARG_SEP"
    TOK_CONGIG_DIR_SEC_COOKIE_FORMAT = 584, // "CONGIG_DIR_SEC_COOKIE_FORMAT"
    TOK_CONFIG_SEC_COOKIEV0_SEPARATOR = 585, // "CONFIG_SEC_COOKIEV0_SEPARATOR"
    TOK_CONGIG_DIR_SEC_DATA_DIR = 586, // "CONGIG_DIR_SEC_DATA_DIR"
    TOK_CONGIG_DIR_SEC_STATUS_ENGINE = 587, // "CONGIG_DIR_SEC_STATUS_ENGINE"
    TOK_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 588, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
    TOK_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 589, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
    TOK_CONGIG_DIR_SEC_TMP_DIR = 590, // "CONGIG_DIR_SEC_TMP_DIR"
    TOK_DIRECTIVE = 591,           // "DIRECTIVE"
    TOK_DIRECTIVE_SECRULESCRIPT = 592, // "DIRECTIVE_SECRULESCRIPT"
    TOK_FREE_TEXT_QUOTE_MACRO_EXPANSION = 593, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
    TOK_QUOTATION_MARK = 594,      // "QUOTATION_MARK"
    TOK_RUN_TIME_VAR_BLD = 595,    // "RUN_TIME_VAR_BLD"
    TOK_RUN_TIME_VAR_DUR = 596,    // "RUN_TIME_VAR_DUR"
    TOK_RUN_TIME_VAR_HSV = 597,    // "RUN_TIME_VAR_HSV"
    TOK_RUN_TIME_VAR_REMOTE_USER = 598, // "RUN_TIME_VAR_REMOTE_USER"
    TOK_RUN_TIME_VAR_TIME = 599,   // "RUN_TIME_VAR_TIME"
    TOK_RUN_TIME_VAR_TIME_DAY = 600, // "RUN_TIME_VAR_TIME_DAY"
    TOK_RUN_TIME_VAR_TIME_EPOCH = 601, // "RUN_TIME_VAR_TIME_EPOCH"
    TOK_RUN_TIME_VAR_TIME_HOUR = 602, // "RUN_TIME_VAR_TIME_HOUR"
    TOK_RUN_TIME_VAR_TIME_MIN = 603, // "RUN_TIME_VAR_TIME_MIN"
    TOK_RUN_TIME_VAR_TIME_MON = 604, // "RUN_TIME_VAR_TIME_MON"
    TOK_RUN_TIME_VAR_TIME_SEC = 605, // "RUN_TIME_VAR_TIME_SEC"
    TOK_RUN_TIME_VAR_TIME_WDAY = 606, // "RUN_TIME_VAR_TIME_WDAY"
    TOK_RUN_TIME_VAR_TIME_YEAR = 607, // "RUN_TIME_VAR_TIME_YEAR"
    TOK_VARIABLE = 608,            // "VARIABLE"
    TOK_DICT_ELEMENT = 609,        // "Dictionary element"
    TOK_DICT_ELEMENT_WITH_EQUALS = 610, // "Dictionary element, with equals"
    TOK_DICT_ELEMENT_REGEXP = 611  // "Dictionary element, selected by regexp"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE = 248, // "CONFIG_DIR_AUDIT_STORAGE_DIR_MODE"
        ...
        S_CONFIG_VALUE_DAY = 313,                // "CONFIG_VALUE_DAY"
        S_CONFIG_VALUE_HOUR = 314,               // "CONFIG_VALUE_HOUR"
        S_CONFIG_VALUE_MINUTE = 315,             // "CONFIG_VALUE_MINUTE"
        S_CONFIG_VALUE_SECOND = 316,             // "CONFIG_VALUE_SECOND"
        S_CONFIG_VALUE_OFF = 317,                // "CONFIG_VALUE_OFF"
        S_CONFIG_VALUE_ON = 318,                 // "CONFIG_VALUE_ON"
        S_CONFIG_VALUE_PARALLEL = 319,           // "CONFIG_VALUE_PARALLEL"
        S_CONFIG_VALUE_PROCESS_PARTIAL = 320,    // "CONFIG_VALUE_PROCESS_PARTIAL"
        S_CONFIG_VALUE_REJECT = 321,             // "CONFIG_VALUE_REJECT"
        S_CONFIG_VALUE_RELEVANT_ONLY = 322,      // "CONFIG_VALUE_RELEVANT_ONLY"
        S_CONFIG_VALUE_SERIAL = 323,             // "CONFIG_VALUE_SERIAL"
        S_CONFIG_VALUE_WARN = 324,               // "CONFIG_VALUE_WARN"
        S_CONFIG_XML_EXTERNAL_ENTITY = 325,      // "CONFIG_XML_EXTERNAL_ENTITY"
        S_CONFIG_XML_PARSE_XML_INTO_ARGS = 326,  // "CONFIG_XML_PARSE_XML_INTO_ARGS"
        S_CONGIG_DIR_RESPONSE_BODY_MP = 327,     // "CONGIG_DIR_RESPONSE_BODY_MP"
        S_CONGIG_DIR_SEC_ARG_SEP = 328,          // "CONGIG_DIR_SEC_ARG_SEP"
        S_CONGIG_DIR_SEC_COOKIE_FORMAT = 329,    // "CONGIG_DIR_SEC_COOKIE_FORMAT"
        S_CONFIG_SEC_COOKIEV0_SEPARATOR = 330,   // "CONFIG_SEC_COOKIEV0_SEPARATOR"
        S_CONGIG_DIR_SEC_DATA_DIR = 331,         // "CONGIG_DIR_SEC_DATA_DIR"
        S_CONGIG_DIR_SEC_STATUS_ENGINE = 332,    // "CONGIG_DIR_SEC_STATUS_ENGINE"
        S_CONFIG_SEC_STREAM_IN_BODY_INSPECTION = 333, // "CONFIG_SEC_STREAM_IN_BODY_INSPECTION"
        S_CONFIG_SEC_STREAM_OUT_BODY_INSPECTION = 334, // "CONFIG_SEC_STREAM_OUT_BODY_INSPECTION"
        S_CONGIG_DIR_SEC_TMP_DIR = 335,          // "CONGIG_DIR_SEC_TMP_DIR"
        S_DIRECTIVE = 336,                       // "DIRECTIVE"
        S_DIRECTIVE_SECRULESCRIPT = 337,         // "DIRECTIVE_SECRULESCRIPT"
        S_FREE_TEXT_QUOTE_MACRO_EXPANSION = 338, // "FREE_TEXT_QUOTE_MACRO_EXPANSION"
        S_QUOTATION_MARK = 339,                  // "QUOTATION_MARK"
        S_RUN_TIME_VAR_BLD = 340,                // "RUN_TIME_VAR_BLD"
        S_RUN_TIME_VAR_DUR = 341,                // "RUN_TIME_VAR_DUR"
        S_RUN_TIME_VAR_HSV = 342,                // "RUN_TIME_VAR_HSV"
        S_RUN_TIME_VAR_REMOTE_USER = 343,        // "RUN_TIME_VAR_REMOTE_USER"
        S_RUN_TIME_VAR_TIME = 344,               // "RUN_TIME_VAR_TIME"
        S_RUN_TIME_VAR_TIME_DAY = 345,           // "RUN_TIME_VAR_TIME_DAY"
        S_RUN_TIME_VAR_TIME_EPOCH = 346,         // "RUN_TIME_VAR_TIME_EPOCH"
        S_RUN_TIME_VAR_TIME_HOUR = 347,          // "RUN_TIME_VAR_TIME_HOUR"
        S_RUN_TIME_VAR_TIME_MIN = 348,           // "RUN_TIME_VAR_TIME_MIN"
        S_RUN_TIME_VAR_TIME_MON = 349,           // "RUN_TIME_VAR_TIME_MON"
        S_RUN_TIME_VAR_TIME_SEC = 350,           // "RUN_TIME_VAR_TIME_SEC"
        S_RUN_TIME_VAR_TIME_WDAY = 351,          // "RUN_TIME_VAR_TIME_WDAY"
        S_RUN_TIME_VAR_TIME_YEAR = 352,          // "RUN_TIME_VAR_TIME_YEAR"
        S_VARIABLE = 353,                        // "VARIABLE"
        S_DICT_ELEMENT = 354,                    // "Dictionary element"
        S_DICT_ELEMENT_WITH_EQUALS = 355,        // "Dictionary element, with equals"
        S_DICT_ELEMENT_REGEXP = 356,             // "Dictionary element, selected by regexp"
        S_YYACCEPT = 357,                        // $accept
        S_input = 358,                           // input
        S_line = 359,                            // line
        S_audit_log = 360,                       // audit_log
        S_actions = 361,                         // actions
        S_actions_may_quoted = 362,              // actions_may_quoted
        S_op = 363,                              // op
        S_op_before_init = 364,                  // op_before_init
        S_expression = 365,                      // expression
        S_variables = 366,                       // variables
        S_variables_pre_process = 367,           // variables_pre_process
        S_variables_may_be_quoted = 368,         // variables_may_be_quoted
        S_var = 369,                             // var
        S_act = 370,                             // act
        S_setvar_action = 371,                   // setvar_action
        S_run_time_string = 372                  // run_time_string
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE: // "CONFIG_DIR_AUDIT_STORAGE_DIR_MODE"
      ...
      case symbol_kind::S_CONFIG_VALUE_DAY: // "CONFIG_VALUE_DAY"
      case symbol_kind::S_CONFIG_VALUE_HOUR: // "CONFIG_VALUE_HOUR"
      case symbol_kind::S_CONFIG_VALUE_MINUTE: // "CONFIG_VALUE_MINUTE"
      case symbol_kind::S_CONFIG_VALUE_SECOND: // "CONFIG_VALUE_SECOND"
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CONFIG_DIR_AUDIT_STORAGE_DIR_MODE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CONFIG_VALUE_DAY (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_DAY, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_VALUE_DAY (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_DAY, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONFIG_VALUE_HOUR (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_HOUR, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_VALUE_HOUR (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_HOUR, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONFIG_VALUE_MINUTE (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_MINUTE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_VALUE_MINUTE (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_MINUTE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONFIG_VALUE_SECOND (std::string v, location_type l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_SECOND, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_VALUE_SECOND (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_CONFIG_VALUE_SECOND, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    enum
    {
      yylast_ = 3445,     ///< Last index in yytable_.
      yynnts_ = 16,  ///< Number of nonterminal symbols.
      yyfinal_ = 352 ///< Termination state number.
    };
...
#line 8936 "src/parser/seclang-parser.hh"




#endif // !YY_YY_SRC_PARSER_SECLANG_PARSER_HH_INCLUDED
