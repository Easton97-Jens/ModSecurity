...
VARIABLE_ARGS_GET_NAMES                   (?i:ARGS_GET_NAMES(?:_RAW)?)
VARIABLE_ARGS_NAMES                       (?i:ARGS_NAMES(?:_RAW)?)
VARIABLE_ARGS_POST_NAMES                  (?i:ARGS_POST_NAMES(?:_RAW)?)
...
VARIABLE_ARGS                             (?i:ARGS(?:_RAW)?)
VARIABLE_ARGS_POST                        (?i:ARGS_POST(?:_RAW)?)
VARIABLE_ARGS_GET                         (?i:ARGS_GET(?:_RAW)?)
